...
The proposed system was compared against a pure Sentence-BERT-style semantic approach and an optional hybrid configuration that preserves regex-based hard-skill verification while replacing the context component with a semantic embedding score. The test resume used semantically related phrasing such as ``RESTful'' instead of ``REST'' and ``directed a team'' instead of ``leadership''. This benchmark highlights the lexical limitations of the lightweight system and the semantic advantage of embeddings.
